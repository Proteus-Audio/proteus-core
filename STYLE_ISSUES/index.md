...
| [ ]  | SI-06 | [SI-06-spawn-mix-thread-god-function.md](./SI-06-spawn-mix-thread-god-function.md) | `spawn_mix_thread` (~536 lines) in `runner/mod.rs` exceeds function-length limits and keeps the file over the 600-line hard limit |
